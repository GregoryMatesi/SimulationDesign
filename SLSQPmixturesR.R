...
mixtures <- function(A, pop){
    ...
    end_time = Sys.time()
    returnThese <- list(S$par, S$iter, end_time - start_time)  # pi estimates, # of iterations, and time. To be returned.
    returnThese   # return 3 things.
    #S$par
    #end_time - start_time
